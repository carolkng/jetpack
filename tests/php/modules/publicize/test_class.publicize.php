...
class WP_Test_Publicize extends WP_UnitTestCase {
	...
	/**
	 * Connection unique ID in 'process_publicize_from_rest' test data.
	 *
	 * @since 6.7.0
	 * @var integer CONNECTION_UID connection unique ID.
	 */
	...
	public function test_flag_connection_for_no_share() {
		...
		$this->publicize->process_publicize_from_rest( $new_post, $request );
	...
	public function test_not_publishing() {
		 ...
		 */
		$this->publicize->process_publicize_from_rest( $this->post, $request );
